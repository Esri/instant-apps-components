...
declare module '@stencil/core' {
  export namespace JSX {
    interface IntrinsicElements {
      ...
      'instant-apps-interactive-legend-layer-caption': LocalJSX.InstantAppsInteractiveLegendLayerCaption &
        JSXBase.HTMLAttributes<HTMLInstantAppsInteractiveLegendLayerCaptionElement>;
      'instant-apps-interactive-legend-relationship': LocalJSX.InstantAppsInteractiveLegendRelationship &
        JSXBase.HTMLAttributes<HTMLInstantAppsInteractiveLegendRelationshipElement>;
