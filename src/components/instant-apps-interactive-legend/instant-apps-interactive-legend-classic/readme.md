...
| `legendvm`     | --              | Legend View model from the 4.x ArcGIS API for JavaScript                                       | `LegendViewModel` | `undefined`           |
...
- [instant-apps-interactive-legend](../instant-apps-interactive-legend)
