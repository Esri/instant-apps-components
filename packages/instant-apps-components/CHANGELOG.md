...
- Update interfaces.d.ts and package.json
...
- Updated JSAPI version number to latest

### instant-apps-keyboard-shortcuts

- Disable rotation commands if rotation is disabled on the view

### instant-apps-language-switcher

- localize util functions from TCL to prevent AMD/ESM incompatibility

## v1.0.0-beta.304

### General

- Upgrade Calcite Components to v3

## v1.0.0-beta.303

### instant-apps-language-switcher

- use calculateLocale from TCL
...
- add @Method to update t9n for filterLayerExpressions

## v1.0.0-beta.299

### instant-apps-scoreboard

- fix: Only check for 'view.update' if 'queryType' = 'layerView'.
...
- Add property to determine whether stats query is queried against feature layer service or feature layer view

## v1.0.0-beta.296

### instant-apps-export

- fix: add try catch for converting print to image. `logoImage` might cause CORS issues so remove image in catch and then retry.

## v1.0.0-beta.295

### instant-apps-time-filter

- Add additional check for featureEffect.filter

## v1.0.0-beta.294

### instant-apps-filter-list

- add @Method `updateInitDefExpressions`

## v1.0.0-beta.293

### instant-apps-filter-list

- add `getCurrentLayerExpressions()`
...
- fix: don't clone layerExpressions on forceReset

## v1.0.0-beta.287

### instant-apps-filter-list

- fix: add check for undefined in switch

### General

- chore: Translation file updates
...
- Change sign in button to solid appearance with border
...
- fix: Update SCSS to set text-align based on alignment property value
...
- UI updates for compact mode

## v1.0.0-beta.277

### instant-apps-export

- add `logoImage`, image URL for logo in export's header

## v1.0.0-beta.276

### General

- Upgrade Calcite Components to 2.13.0

## v1.0.0-beta.275

### instant-apps-interactive-legend

- Initial implementation of compact mode.

## v1.0.0-beta.274

### instant-apps-sign-in

- add gap to sign in buttons

## v1.0.0-beta.273

### instant-apps-time-filter

- fix: time slider instantiation for map type

### instant-apps-language-switcher

- feat: expose 'overlayPositioning' prop for calcite-dropdown in language switcher
...
- chore: set 'respectLayerDefinitionExpression' to `true`

## v1.0.0-beta.270

### instant-apps-app-guide

- fix header issues caused by possible race condition

## v1.0.0-beta.269

### instant-apps-sign-in

- add `user-id` to calcite-avatar

### instant-apps-export

- add `respectLayerDefinitionExpression` to Legend
...
- feat: add the App Guide component to display information that describes features of a tool or Instant App

## v1.0.0-beta.264

### instant-apps-filter-list

- fix: properly reset and re-initialize the filter and expressions when forceReset is called

## v1.0.0-beta.263

### instant-apps-time-filter

- fix: properly instantiate time slider if type in config is set to 'map'
