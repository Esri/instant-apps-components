...
import { ITimeInfoConfigItem } from "./components/instant-apps-time-filter/interfaces/interfaces";
...
export { ITimeInfoConfigItem } from "./components/instant-apps-time-filter/interfaces/interfaces";
