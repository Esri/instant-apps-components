...
| `options`            | --                    | Lists the options displayed in the UI. There are 5 Predefined options. If you need to add custom options, then define a CustomOption entry in the array.                                                                                                                                                                                                                        | `(PredefinedOptions \| CreateOption)[]`          | `['instant-apps', 'map-viewer', 'story-maps', 'experience-builder', 'dashboards'];` |
