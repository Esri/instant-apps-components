import { r as registerInstance, h as h$l, H as Host, g as getAssetPath, a as getElement } from './index-c2b6dfe1.js';
...
let InstantAppsHeader = class {
  ...
  render() {
    return (h$l(Host, null, h$l("header", { style: { backgroundColor: this.backgroundColor } }, h$l("span", { class: CSS$1.headerContent }, this.logoImage && this.logoLink ? (h$l("a", { href: `${this.logoLink}`, target: "_blank" }, h$l("img", { src: `${this.logoImage}`, alt: `${this.logoImageAltText}` }))) : this.logoImage ? (h$l("img", { src: `${this.logoImage}`, alt: this.logoImageAltText })) : (''), h$l("h1", { style: { color: this.textColor } }, this.titleText)), h$l("slot", { name: "actions-end" }))));
  }
};
...
let InstantAppsSocialShare = class {
  ...
  render() {
    ...
    const content = this.copied && this.mode === 'popover' ? (this.renderSuccess()) : (h$l("div", { class: CSS.dialogContent }, this.renderOptions(), this.mode === 'popover' && !this.embed && this.displayTipText ? this.renderTip() : null, this.embed ? this.renderEmbed() : null));
    const dialogContent = (h$l("div", { ref: el => (this.dialogContentRef = el), class: CSS.dialog }, content));
    return (h$l(Host, null, this.mode === 'popover'
      ? [
        h$l("calcite-popover", { ref: (el) => (this.popoverRef = el), label: (_b = (_a = this.messages) === null || _a === void 0 ? void 0 : _a.share) === null || _b === void 0 ? void 0 : _b.label, "reference-element": "shareButton", placement: "bottom-start", scale: this.scale }, dialogContent),
        h$l("calcite-button", { onClick: this.togglePopover.bind(this), id: "shareButton", color: this.shareButtonColor, appearance: "transparent", label: (_d = (_c = this.messages) === null || _c === void 0 ? void 0 : _c.share) === null || _d === void 0 ? void 0 : _d.label, title: (_f = (_e = this.messages) === null || _e === void 0 ? void 0 : _e.share) === null || _f === void 0 ? void 0 : _f.label, scale: this.scale }, h$l("calcite-icon", { icon: "share", scale: "m" })),
      ]
      : [
        dialogContent,
        h$l("calcite-popover", { ref: (el) => (this.copyLinkPopoverRef = el), label: (_h = (_g = this.messages) === null || _g === void 0 ? void 0 : _g.share) === null || _h === void 0 ? void 0 : _h.label, "reference-element": "copyToClipboard", placement: "trailing", scale: this.scale }, this.renderSuccess()),
        h$l("calcite-popover", { ref: (el) => (this.copyEmbedPopoverRef = el), label: (_k = (_j = this.messages) === null || _j === void 0 ? void 0 : _j.share) === null || _k === void 0 ? void 0 : _k.label, "reference-element": "copyEmbedToClipboard", placement: "trailing", scale: this.scale }, this.renderEmbedSuccess()),
      ]));
  }
  renderSuccess() {
    var _a;
    const success = (_a = this.messages) === null || _a === void 0 ? void 0 : _a.success;
    return (h$l("div", { class: CSS.success.container }, h$l("span", { class: CSS.success.header }, h$l("span", { class: CSS.success.icon }, h$l("calcite-icon", { icon: "check-circle-f", scale: this.scale })), success === null || success === void 0 ? void 0 :
  ...
  renderOptions() {
    ...
    return (h$l("ul", { class: CSS.options, role: "menu" }, h$l("li", { id: "copyToClipboard", onClick: this.handleShareItem.bind(this, 'link'), role: "menuitem" }, h$l("span", { class: CSS.icon }, h$l("calcite-icon", { icon: "link", scale: this.scale })), h$l("span", { class: CSS.optionText }, (_b = options === null || options === void 0 ? void 0 : options.link) === null || _b === void 0 ? void 0 : _b.label)), this.socialMedia
      ? [
        h$l("li", { onClick: this.handleShareItem.bind(this, 'facebook'), role: "menuitem" }, h$l("span", { class: CSS.icon }, this.renderFacebookIcon()), h$l("span", { class: CSS.optionText }, (_c = options === null || options === void 0 ? void 0 : options.facebook) === null || _c === void 0 ? void 0 : _c.label)),
        h$l("li", { onClick: this.handleShareItem.bind(this, 'twitter'), role: "menuitem" }, h$l("span", { class: CSS.icon }, this.renderTwitterIcon()), h$l("span", { class: CSS.optionText }, (_d = options === null || options === void 0 ? void 0 : options.twitter) === null || _d === void 0 ? void 0 : _d.label)),
        h$l("li", { onClick: this.handleShareItem.bind(this, 'linkedIn'), role: "menuitem" }, h$l("span", { class: CSS.icon }, this.renderLinkedInIcon()), h$l("span", { class: CSS.optionText }, (_e = options === null || options === void 0 ? void 0 : options.linkedIn) === null || _e === void 0 ? void 0 : _e.label)),
      ]
      : null));
  }
  renderFacebookIcon() {
  ...
  renderTip() {
    ...
    return (h$l("div", { class: CSS.tipContainer }, h$l("span", { class: CSS.tipHeader }, h$l("calcite-icon", { icon: "lightbulb", scale: this.scale }), h$l("span", null, info === null || info === void 0 ? void 0 : info.label)), h$l("p", { class: CSS.tipContent }, info === null || info === void 0 ? void 0 : info.tooltip)));
  }
  renderEmbed() {
    var _a, _b, _c;
    const embedMessages = (_a = this.messages) === null || _a === void 0 ? void 0 : _a.embed;
    return (h$l("div", { class: CSS.embed.container }, h$l("span", { class: CSS.embed.header }, h$l("calcite-icon", { icon: "code", scale: this.scale }), h$l("span", null, (_c = (_b = this.messages) === null || _b === void 0 ? void 0 : _b.embed) === null || _c === void 0 ? void 0 : _c.label)), h$l("div", { class: CSS.embed.embedCode.container }, h$l("div", { class: CSS.embed.embedCode.textArea }, h$l("textarea", { ref: el => (this.embedCodeRef = el), cols: 30, rows: 5, readonly: true, value: this.getEmbedCode() }), h$l("button", { id: "copyEmbedToClipboard", onClick: this.copyEmbedCode.bind(this), class: CSS.embed.embedCode.copyButton }, h$l("calcite-icon", { icon: "copy", scale: this.scale }), h$l("span", null, embedMessages === null || embedMessages === void 0 ? void 0 : embedMessages.copy))), h$l("span", { class: CSS.embed.textAreaText }, h$l("slot", { name: "text-area-text" })), h$l("div", { class: CSS.embed.dimensions.container }, h$l("label", { class: CSS.embed.dimensions.input }, h$l("span", null, embedMessages === null || embedMessages === void 0 ? void 0 : embedMessages.width), h$l("input", { ref: el => (this.embedWidthRef = el), type: "number", value: this.embedWidth })), h$l("label", { class: CSS.embed.dimensions.input }, h$l("span", null, embedMessages === null || embedMessages === void 0 ? void 0 : embedMessages.height), h$l("input", { ref: el => (this.embedHeightRef = el), type: "number", value: this.embedHeight }))))));
  }
  togglePopover(event) {
    event.stopPropagation();
...
export { S$6 as $, q$7 as A, s$i as B, s$f as C, a$f as D, w$a as E, l$o as F, f$s as G, c$k as H, E$8 as I, u$q as J, s$x as K, a$8 as L, M$1 as M, N$4 as N, n$f as O, y$e as P, y$d as Q, O$5 as R, z$7 as S, T$4 as T, p$j as U, B$6 as V, C$5 as W, b$8 as X, r$n as Y, r$p as Z, W$2 as _, m$1 as a, t$o as a0, C$6 as a1, o$p as a2, InstantAppsHeader as a3, InstantAppsSocialShare as a4, e$n as b, s$h as c, e$f as d, e$x as e, b$7 as f, d$d as g, i$g as h, i$d as i, j$4 as j, v$6 as k, l$m as l, m, m$h as n, g$d as o, p$9 as p, q$8 as q, r$j as r, s$v as s, t$c as t, v$c as u, v, s$y as w, N$6 as x, a$i as y, n$d as z };
