...
let InstantAppsSocialShare = class {
  ...
  renderEmbed() {
    ...
    return (h$l("div", { class: CSS.embed.container }, h$l("span", { class: CSS.embed.header }, h$l("calcite-icon", { icon: "code", scale: "m" }), h$l("span", null, (_c = (_b = this.messages) === null || _b === void 0 ? void 0 : _b.embed) === null || _c === void 0 ? void 0 : _c.label)), h$l("div", { class: CSS.embed.embedCode.container }, h$l("div", { class: CSS.embed.embedCode.textArea }, h$l("textarea", { ref: el => (this.embedCodeRef = el), cols: 30, rows: 7, readonly: true, value: this.getEmbedCode() }), h$l("button", { id: "copyEmbedToClipboard", onClick: this.copyEmbedCode.bind(this), class: CSS.embed.embedCode.copyButton }, h$l("calcite-icon", { icon: "copy", scale: "s" }), h$l("span", null, embedMessages === null || embedMessages === void 0 ? void 0 : embedMessages.copy))), h$l("div", { class: CSS.embed.dimensions.container }, h$l("label", { class: CSS.embed.dimensions.input }, h$l("span", null, embedMessages === null || embedMessages === void 0 ? void 0 : embedMessages.width), h$l("input", { ref: el => (this.embedWidthRef = el), type: "number", value: this.embedWidth })), h$l("label", { class: CSS.embed.dimensions.input }, h$l("span", null, embedMessages === null || embedMessages === void 0 ? void 0 : embedMessages.height), h$l("input", { ref: el => (this.embedHeightRef = el), type: "number", value: this.embedHeight }))))));
  }
  togglePopover(event) {
    event.stopPropagation();
