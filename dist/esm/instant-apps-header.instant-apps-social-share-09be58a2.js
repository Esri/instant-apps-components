import { r as registerInstance, h as h$n, H as Host, g as getAssetPath, a as getElement } from './index-c2b6dfe1.js';
...
let InstantAppsHeader = class {
  ...
  render() {
    return (h$n(Host, null, h$n("header", { style: { backgroundColor: this.backgroundColor } }, h$n("span", { class: CSS$1.headerContent }, this.logoImage && this.logoLink ? (h$n("a", { href: `${this.logoLink}`, target: "_blank" }, h$n("img", { src: `${this.logoImage}`, alt: `${this.logoImageAltText}` }))) : this.logoImage ? (h$n("img", { src: `${this.logoImage}`, alt: this.logoImageAltText })) : (''), h$n("h1", { style: { color: this.textColor } }, this.titleText)), h$n("slot", { name: "actions-end" }))));
  }
};
...
export { r$n as $, A$4 as A, s$f as B, g$b as C, w$a as D, E$8 as E, l$n as F, f$r as G, c$l as H, y$h as I, u$q as J, s$w as K, l$a as L, M$1 as M, N$4 as N, n$h as O, y$i as P, Q$4 as Q, y$g as R, j$c as S, q$7 as T, U$4 as U, v$c as V, p$i as W, z$6 as X, C$5 as Y, v$b as Z, Z$3 as _, m$1 as a, I$7 as a0, s$y as a1, F$5 as a2, J$3 as a3, t$o as a4, Bt as a5, o$q as a6, InstantAppsHeader as a7, InstantAppsSocialShare as a8, e$p as b, s$g as c, e$h as d, e$z as e, b$7 as f, d$e as g, h$a as h, m$k as i, j$4 as j, v$6 as k, l$g as l, m, n$a as n, m$h as o, g$e as p, q$8 as q, r$j as r, s$u as s, t$c as t, a$r as u, v, s$x as w, n$f as x, a$g as y, s$h as z };
