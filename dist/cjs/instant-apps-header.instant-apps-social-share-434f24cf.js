...
let InstantAppsSocialShare = class {
  ...
  render() {
    ...
    const content = this.copied && this.mode === 'popover' ? (this.renderSuccess()) : (index.h("div", { class: CSS.dialogContent }, this.renderOptions(), this.mode === 'popover' && !this.embed && this.displayTipText ? this.renderTip() : null, this.embed ? this.renderEmbed() : null));
    ...
    return (index.h(index.Host, null, this.mode === 'popover'
      ? [
        ...
        index.h("calcite-button", { onClick: this.togglePopover.bind(this), id: "shareButton", color: this.shareButtonColor, appearance: "transparent", label: (_d = (_c = this.messages) === null || _c === void 0 ? void 0 : _c.share) === null || _d === void 0 ? void 0 : _d.label, title: (_f = (_e = this.messages) === null || _e === void 0 ? void 0 : _e.share) === null || _f === void 0 ? void 0 : _f.label, scale: this.scale }, index.h("calcite-icon", { icon: "share", scale: "m" })),
      ]
      : [
        dialogContent,
