...
See https://js.arcgis.com/4.22/esri/copyright.txt for details.
*/
var n$h,l$l,o$t;let e$t,i$s;const t$n=null!=(n$h=null==(l$l=globalThis.esriConfig)?void 0:l$l.locale)?n$h:null==(o$t=globalThis.dojoConfig)?void 0:o$t.locale;function u$t(){var n,l;return null!=(n=null!=t$n?t$n:null==(l=globalThis.navigator)?void 0:l.language)?n:"en"}function a$p(){return void 0===i$s&&(i$s=u$t()),i$s}const d$h=[];function f$s(n){return d$h.push(n),{remove(){d$h.splice(d$h.indexOf(n),1);}}}const g$e=[];function h$k(n){return g$e.push(n),{remove(){d$h.splice(g$e.indexOf(n),1);}}}function b$9(){var n;const l=null!=(n=e$t)?n:u$t();i$s!==l&&(i$s=l,[...g$e].forEach((n=>{n.call(null,l);})),[...d$h].forEach((n=>{n.call(null,l);})));}null==globalThis.addEventListener||globalThis.addEventListener("languagechange",b$9);

/*
All material copyright ESRI, All Rights Reserved, unless otherwise specified.
See https://js.arcgis.com/4.22/esri/copyright.txt for details.
*/
const r$q={year:"numeric",month:"numeric",day:"numeric"},n$g={year:"numeric",month:"long",day:"numeric"},a$o={year:"numeric",month:"short",day:"numeric"},h$j={year:"numeric",month:"long",weekday:"long",day:"numeric"},m$j={hour:"numeric",minute:"numeric"},i$r={...m$j,second:"numeric"},s$A={"short-date":r$q,"short-date-short-time":{...r$q,...m$j},"short-date-short-time-24":{...r$q,...m$j,hour12:!1},"short-date-long-time":{...r$q,...i$r},"short-date-long-time-24":{...r$q,...i$r,hour12:!1},"short-date-le":r$q,"short-date-le-short-time":{...r$q,...m$j},"short-date-le-short-time-24":{...r$q,...m$j,hour12:!1},"short-date-le-long-time":{...r$q,...i$r},"short-date-le-long-time-24":{...r$q,...i$r,hour12:!1},"long-month-day-year":n$g,"long-month-day-year-short-time":{...n$g,...m$j},"long-month-day-year-short-time-24":{...n$g,...m$j,hour12:!1},"long-month-day-year-long-time":{...n$g,...i$r},"long-month-day-year-long-time-24":{...n$g,...i$r,hour12:!1},"day-short-month-year":a$o,"day-short-month-year-short-time":{...a$o,...m$j},"day-short-month-year-short-time-24":{...a$o,...m$j,hour12:!1},"day-short-month-year-long-time":{...a$o,...i$r},"day-short-month-year-long-time-24":{...a$o,...i$r,hour12:!1},"long-date":h$j,"long-date-short-time":{...h$j,...m$j},"long-date-short-time-24":{...h$j,...m$j,hour12:!1},"long-date-long-time":{...h$j,...i$r},"long-date-long-time-24":{...h$j,...i$r,hour12:!1},"long-month-year":{month:"long",year:"numeric"},"short-month-year":{month:"short",year:"numeric"},year:{year:"numeric"},"short-time":m$j,"long-time":i$r},l$k=s$B()({shortDate:"short-date",shortDateShortTime:"short-date-short-time",shortDateShortTime24:"short-date-short-time-24",shortDateLongTime:"short-date-long-time",shortDateLongTime24:"short-date-long-time-24",shortDateLE:"short-date-le",shortDateLEShortTime:"short-date-le-short-time",shortDateLEShortTime24:"short-date-le-short-time-24",shortDateLELongTime:"short-date-le-long-time",shortDateLELongTime24:"short-date-le-long-time-24",longMonthDayYear:"long-month-day-year",longMonthDayYearShortTime:"long-month-day-year-short-time",longMonthDayYearShortTime24:"long-month-day-year-short-time-24",longMonthDayYearLongTime:"long-month-day-year-long-time",longMonthDayYearLongTime24:"long-month-day-year-long-time-24",dayShortMonthYear:"day-short-month-year",dayShortMonthYearShortTime:"day-short-month-year-short-time",dayShortMonthYearShortTime24:"day-short-month-year-short-time-24",dayShortMonthYearLongTime:"day-short-month-year-long-time",dayShortMonthYearLongTime24:"day-short-month-year-long-time-24",longDate:"long-date",longDateShortTime:"long-date-short-time",longDateShortTime24:"long-date-short-time-24",longDateLongTime:"long-date-long-time",longDateLongTime24:"long-date-long-time-24",longMonthYear:"long-month-year",shortMonthYear:"short-month-year",year:"year"});l$k.toJSON.bind(l$k);l$k.fromJSON.bind(l$k);const u$s={ar:"ar-u-nu-latn-ca-gregory"};let c$t=new WeakMap,D$9=s$A["short-date-short-time"];function T$5(t){const o=t||D$9;if(!c$t.has(o)){const t=a$p(),r=u$s[a$p()]||t;c$t.set(o,new Intl.DateTimeFormat(r,o));}return c$t.get(o)}function L$5(t,o){return T$5(o).format(t)}h$k((()=>{c$t=new WeakMap,D$9=s$A["short-date-short-time"];}));

/*
All material copyright ESRI, All Rights Reserved, unless otherwise specified.
See https://js.arcgis.com/4.22/esri/copyright.txt for details.
*/
const a$n={ar:"ar-u-nu-latn"};let e$s=new WeakMap,o$s={};function i$q(n){const i=n||o$s;if(!e$s.has(i)){const t=a$p(),o=a$n[a$p()]||t;e$s.set(i,new Intl.NumberFormat(o,n));}return q$8(e$s.get(i))}function m$i(t,n){return i$q(n).format(t)}h$k((()=>{e$s=new WeakMap,o$s={};}));

/*
All material copyright ESRI, All Rights Reserved, unless otherwise specified.
See https://js.arcgis.com/4.22/esri/copyright.txt for details.
*/
var s$z;const r$p={apiKey:void 0,applicationUrl:null==(s$z=globalThis.location)?void 0:s$z.href,assetsPath:"",fontsUrl:"https://static.arcgis.com/fonts",geometryService:null,geometryServiceUrl:"https://utility.arcgisonline.com/arcgis/rest/services/Geometry/GeometryServer",geoRSSServiceUrl:"https://utility.arcgis.com/sharing/rss",kmlServiceUrl:"https://utility.arcgis.com/sharing/kml",portalUrl:"https://www.arcgis.com",workers:{loaderConfig:{has:{},paths:{},map:{},packages:[]}},request:{httpsDomains:["arcgis.com","arcgisonline.com","esrikr.com","premiumservices.blackbridge.com","esripremium.accuweather.com","gbm.digitalglobe.com","firstlook.digitalglobe.com","msi.digitalglobe.com"],interceptors:[],maxUrlLength:2e3,proxyRules:[],proxyUrl:null,timeout:6e4,trustedServers:[],useIdentity:!0},log:{interceptors:[],level:null}};if(globalThis.esriConfig&&(n$i(r$p,globalThis.esriConfig,!0),delete r$p.has),!r$p.assetsPath){const e="4.22.2";r$p.assetsPath=`https://js.arcgis.com/${e.slice(0,-2)}/@arcgis/core/assets`;}r$p.baseUrl&&console.warn("[esri.config]","baseUrl has been replaced by assetsPath"),Object.defineProperty(r$p,"baseUrl",{set(){console.warn("[esri.config]","baseUrl has been replaced by assetsPath");}}),r$p.request.corsEnabledServers=[],r$p.request.corsEnabledServers.push=function(){return console.warn("[esri.config]","request.corsEnabledServers is not supported and will be removed in a future release. See http://esriurl.com/cors8664"),0};

/*
All material copyright ESRI, All Rights Reserved, unless otherwise specified.
See https://js.arcgis.com/4.22/esri/copyright.txt for details.
*/
const e$r=/\{([^\}]+)\}/g;function n$f(t){return null==t?"":t}function r$o(r,o){return r.replace(e$r,"object"==typeof o?(e,r)=>n$f(t$o(r,o)):(t,e)=>n$f(o(e)))}function c$s(t){let e=0;for(let n=0;n<t.length;n++)e=(e<<5)-e+t.charCodeAt(n),e|=0;return e}
...
See https://js.arcgis.com/4.22/esri/copyright.txt for details.
*/
let r$c=!1;const e$b=[];function o$b(e,o){let u=new s$f(s),l=null,f=!1;function s(){if(!u||f)return;if(r$c)return void i$a(s);const t=l;u.clear(),r$c=!0,f=!0,l=a$e(u,e),f=!1,r$c=!1,o(l,t),c$f();}function m(){u&&(u.destroy(),u=null,l=null);}return f=!0,l=a$e(u,e),f=!1,{remove:m}}function u$f(r,e){let o=new s$f(l),u=null;function l(){e(u,c);}function i(){o&&(o.destroy(),o=null),u=null;}function c(){return o?(o.clear(),u=a$e(o,r),u):null}return c(),{remove:i}}function i$a(n){e$b.includes(n)||e$b.unshift(n);}function c$f(){for(;e$b.length;)e$b.pop()();}
...
let InstantAppsSocialShare = class {
  ...
  render() {
    ...
    const content = this.copied && this.mode === 'popover' ? (this.renderSuccess()) : (index.h("div", { class: CSS.dialogContent }, this.renderOptions(), this.mode === 'popover' && !this.embed ? this.renderTip() : null, this.embed ? this.renderEmbed() : null));
    const dialogContent = (index.h("div", { ref: el => (this.dialogContentRef = el), class: `${CSS.dialog}${this.mode === 'inline' ? ` ${CSS.dialogEmbed}` : ''}` }, content));
    return this.mode === 'popover'
      ? [
        index.h("calcite-popover", { ref: (el) => (this.popoverRef = el), label: (_b = (_a = this.messages) === null || _a === void 0 ? void 0 : _a.share) === null || _b === void 0 ? void 0 : _b.label, "reference-element": "shareButton", placement: "bottom-start" }, dialogContent),
        index.h("calcite-button", { onClick: this.togglePopover.bind(this), id: "shareButton", color: this.shareButtonColor, appearance: "transparent", label: (_d = (_c = this.messages) === null || _c === void 0 ? void 0 : _c.share) === null || _d === void 0 ? void 0 : _d.label, title: (_f = (_e = this.messages) === null || _e === void 0 ? void 0 : _e.share) === null || _f === void 0 ? void 0 : _f.label }, index.h("calcite-icon", { icon: "share" })),
      ]
      : [
        dialogContent,
        index.h("calcite-popover", { ref: (el) => (this.copyLinkPopoverRef = el), label: (_h = (_g = this.messages) === null || _g === void 0 ? void 0 : _g.share) === null || _h === void 0 ? void 0 : _h.label, "reference-element": "copyToClipboard", placement: "trailing" }, this.renderSuccess()),
        index.h("calcite-popover", { ref: (el) => (this.copyEmbedPopoverRef = el), label: (_k = (_j = this.messages) === null || _j === void 0 ? void 0 : _j.share) === null || _k === void 0 ? void 0 : _k.label, "reference-element": "copyEmbedToClipboard", placement: "trailing" }, this.renderEmbedSuccess()),
      ];
  }
  renderSuccess() {
    var _a;
    const success = (_a = this.messages) === null || _a === void 0 ? void 0 : _a.success;
    return (index.h("div", { class: CSS.success.container }, index.h("span", { class: CSS.success.header }, index.h("span", { class: CSS.success.icon }, index.h("calcite-icon", { icon: "check-circle-f", scale: "s" })), success === null || success === void 0 ? void 0 :
  ...
  renderOptions() {
    ...
    return (index.h("ul", { class: CSS.options, role: "menu" }, index.h("li", { id: "copyToClipboard", onClick: this.handleShareItem.bind(this, 'link'), role: "menuitem" }, index.h("span", { class: CSS.icon }, index.h("calcite-icon", { icon: "link", scale: "m" })), index.h("span", { class: CSS.optionText }, (_b = options === null || options === void 0 ? void 0 : options.link) === null || _b === void 0 ? void 0 : _b.label)), index.h("li", { onClick: this.handleShareItem.bind(this, 'facebook'), role: "menuitem" }, index.h("span", { class: CSS.icon }, this.renderFacebookIcon()), index.h("span", { class: CSS.optionText }, (_c = options === null || options === void 0 ? void 0 : options.facebook) === null || _c === void 0 ? void 0 : _c.label)), index.h("li", { onClick: this.handleShareItem.bind(this, 'twitter'), role: "menuitem" }, index.h("span", { class: CSS.icon }, this.renderTwitterIcon()), index.h("span", { class: CSS.optionText }, (_d = options === null || options === void 0 ? void 0 : options.twitter) === null || _d === void 0 ? void 0 : _d.label)), index.h("li", { onClick: this.handleShareItem.bind(this, 'linkedIn'), role: "menuitem" }, index.h("span", { class: CSS.icon }, this.renderLinkedInIcon()), index.h("span", { class: CSS.optionText }, (_e = options === null || options === void 0 ? void 0 : options.linkedIn) === null || _e === void 0 ? void 0 : _e.label))));
  }
  renderFacebookIcon() {
  ...
  renderTip() {
    ...
    return (index.h("div", { class: CSS.tipContainer }, index.h("span", { class: CSS.tipHeader }, index.h("calcite-icon", { icon: "lightbulb", scale: "s" }), index.h("span", null, info === null || info === void 0 ? void 0 : info.label)), index.h("p", { class: CSS.tipContent }, info === null || info === void 0 ? void 0 : info.tooltip)));
  }
  renderEmbed() {
    var _a, _b, _c;
    const embedMessages = (_a = this.messages) === null || _a === void 0 ? void 0 : _a.embed;
    return (index.h("div", { class: CSS.embed.container }, index.h("span", { class: CSS.embed.header }, index.h("calcite-icon", { icon: "code", scale: "m" }), index.h("span", null, (_c = (_b = this.messages) === null || _b === void 0 ? void 0 : _b.embed) === null || _c === void 0 ? void 0 : _c.label)), index.h("div", { class: CSS.embed.embedCode.container }, index.h("div", { class: CSS.embed.embedCode.textArea }, index.h("textarea", { ref: el => (this.embedCodeRef = el), cols: 30, rows: 7, readonly: true, value: this.getEmbedCode() }), index.h("button", { id: "copyEmbedToClipboard", onClick: this.copyEmbedCode.bind(this), class: CSS.embed.embedCode.copyButton }, index.h("calcite-icon", { icon: "copy", scale: "s" }), index.h("span", null, embedMessages === null || embedMessages === void 0 ? void 0 : embedMessages.copy))), index.h("div", { class: CSS.embed.dimensions.container }, index.h("label", { class: CSS.embed.dimensions.input }, index.h("span", null, embedMessages === null || embedMessages === void 0 ? void 0 : embedMessages.width), index.h("input", { ref: el => (this.embedWidthRef = el), type: "number", value: this.embedWidth })), index.h("label", { class: CSS.embed.dimensions.input }, index.h("span", null, embedMessages === null || embedMessages === void 0 ? void 0 : embedMessages.height), index.h("input", { ref: el => (this.embedHeightRef = el), type: "number", value: this.embedHeight }))))));
  }
  togglePopover(event) {
    event.stopPropagation();
  ...
  generateShareUrlParams(point) {
    ...
    // If no "?", then append "?". Otherwise, check for "?" and "="
    const sep = path.indexOf('?') === -1 ? '?' : path.indexOf('?') !== -1 && path.indexOf('=') !== -1 ? '&' : '';
    const shareParams = `${path}${sep}center=${roundedLon};${roundedLat}&level=${roundedZoom}${layerId && hiddenLayers.indexOf(layerId) === -1 && graphic ? `&selectedFeature=${layerId};${oid}` : ''}${hiddenLayers ? `&hiddenLayers=${hiddenLayers}` : ''}${this.queryString ? (sep === '?' ? `&${this.queryString}` : `?${this.queryString}`) : ''}`;
...
exports.C$1 = C$6;
exports.E = E$8;
exports.InstantAppsHeader = InstantAppsHeader;
exports.InstantAppsSocialShare = InstantAppsSocialShare;
exports.M = M$1;
exports.N = N$4;
exports.N$1 = N$6;
exports.O = O$5;
