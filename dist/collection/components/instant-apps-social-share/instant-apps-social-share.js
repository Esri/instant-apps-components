...
export class InstantAppsSocialShare {
  ...
  render() {
    ...
    return (h(Host, null, this.mode === 'popover'
      ? [
        ...
        h("calcite-button", { onClick: this.togglePopover.bind(this), id: "shareButton", color: this.shareButtonColor, appearance: "transparent", label: (_d = (_c = this.messages) === null || _c === void 0 ? void 0 : _c.share) === null || _d === void 0 ? void 0 : _d.label, title: (_f = (_e = this.messages) === null || _e === void 0 ? void 0 : _e.share) === null || _f === void 0 ? void 0 : _f.label, scale: this.scale },
    ...
    return (h("div", { class: CSS.success.container },
      h("span", { class: CSS.success.header },
        h("span", { class: CSS.success.icon },
          h("calcite-icon", { icon: "check-circle-f", scale: this.scale })), success === null || success === void 0 ? void 0 :
        success.label),
  ...
  renderTip() {
    ...
    return (h("div", { class: CSS.tipContainer },
      h("span", { class: CSS.tipHeader },
        h("calcite-icon", { icon: "lightbulb", scale: this.scale }),
  ...
  renderEmbed() {
    ...
    return (h("div", { class: CSS.embed.container },
      h("span", { class: CSS.embed.header },
        h("calcite-icon", { icon: "code", scale: this.scale }),
      ...
      h("div", { class: CSS.embed.embedCode.container },
        h("div", { class: CSS.embed.embedCode.textArea },
          ...
          h("button", { id: "copyEmbedToClipboard", onClick: this.copyEmbedCode.bind(this), class: CSS.embed.embedCode.copyButton },
            h("calcite-icon", { icon: "copy", scale: this.scale }),
  ...
  static get properties() { return {
    ...
    "defaultUrlParams": {
      ...
      "mutable": false,
      "complexType": {
        "original": "{ center?: boolean; level?: boolean; viewpoint?: boolean; selectedFeature?: boolean; hiddenLayers?: boolean } | null",
        "resolved": "null | { center?: boolean | undefined; level?: boolean | undefined; viewpoint?: boolean | undefined; selectedFeature?: boolean | undefined; hiddenLayers?: boolean | undefined; }",
        "references": {}
      },
      "required": false,
      "optional": false,
