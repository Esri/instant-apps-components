...
let InstantAppsSocialShare = class {
  ...
  renderEmbed() {
    ...
    return (h$s("div", { class: CSS.embed.container }, h$s("span", { class: CSS.embed.header }, h$s("calcite-icon", { icon: "code", scale: "m" }), h$s("span", null, (_c = (_b = this.messages) === null || _b === void 0 ? void 0 : _b.embed) === null || _c === void 0 ? void 0 : _c.label)), h$s("div", { class: CSS.embed.embedCode.container }, h$s("div", { class: CSS.embed.embedCode.textArea }, h$s("textarea", { ref: el => (this.embedCodeRef = el), cols: 30, rows: 7, readonly: true, value: this.getEmbedCode() }), h$s("button", { id: "copyEmbedToClipboard", onClick: this.copyEmbedCode.bind(this), class: CSS.embed.embedCode.copyButton }, h$s("calcite-icon", { icon: "copy", scale: "s" }), h$s("span", null, embedMessages === null || embedMessages === void 0 ? void 0 : embedMessages.copy))), h$s("div", { class: CSS.embed.dimensions.container }, h$s("label", { class: CSS.embed.dimensions.input }, h$s("span", null, embedMessages === null || embedMessages === void 0 ? void 0 : embedMessages.width), h$s("input", { ref: el => (this.embedWidthRef = el), type: "number", value: this.embedWidth })), h$s("label", { class: CSS.embed.dimensions.input }, h$s("span", null, embedMessages === null || embedMessages === void 0 ? void 0 : embedMessages.height), h$s("input", { ref: el => (this.embedHeightRef = el), type: "number", value: this.embedHeight }))))));
  }
  togglePopover(event) {
    event.stopPropagation();
