import { g as getAssetPath, r as registerInstance, h as h$s, f as getElement } from './index-4c8f6592.js';
...
let InstantAppsSocialShare = class {
  ...
  render() {
    ...
    const content = this.copied && this.mode === 'popover' ? (this.renderSuccess()) : (h$s("div", { class: CSS.dialogContent }, this.renderOptions(), this.mode === 'popover' && !this.embed ? this.renderTip() : null, this.embed ? this.renderEmbed() : null));
    const dialogContent = (h$s("div", { ref: el => (this.dialogContentRef = el), class: `${CSS.dialog}${this.mode === 'inline' ? ` ${CSS.dialogEmbed}` : ''}` }, content));
    return this.mode === 'popover'
      ? [
        h$s("calcite-popover", { ref: (el) => (this.popoverRef = el), label: (_b = (_a = this.messages) === null || _a === void 0 ? void 0 : _a.share) === null || _b === void 0 ? void 0 : _b.label, "reference-element": "shareButton", placement: "bottom-start" }, dialogContent),
        h$s("calcite-button", { onClick: this.togglePopover.bind(this), id: "shareButton", color: this.shareButtonColor, appearance: "transparent", label: (_d = (_c = this.messages) === null || _c === void 0 ? void 0 : _c.share) === null || _d === void 0 ? void 0 : _d.label, title: (_f = (_e = this.messages) === null || _e === void 0 ? void 0 : _e.share) === null || _f === void 0 ? void 0 : _f.label }, h$s("calcite-icon", { icon: "share" })),
      ]
      : [
        dialogContent,
        h$s("calcite-popover", { ref: (el) => (this.copyLinkPopoverRef = el), label: (_h = (_g = this.messages) === null || _g === void 0 ? void 0 : _g.share) === null || _h === void 0 ? void 0 : _h.label, "reference-element": "copyToClipboard", placement: "trailing" }, this.renderSuccess()),
        h$s("calcite-popover", { ref: (el) => (this.copyEmbedPopoverRef = el), label: (_k = (_j = this.messages) === null || _j === void 0 ? void 0 : _j.share) === null || _k === void 0 ? void 0 : _k.label, "reference-element": "copyEmbedToClipboard", placement: "trailing" }, this.renderEmbedSuccess()),
      ];
  }
  renderSuccess() {
    var _a;
    const success = (_a = this.messages) === null || _a === void 0 ? void 0 : _a.success;
    return (h$s("div", { class: CSS.success.container }, h$s("span", { class: CSS.success.header }, h$s("span", { class: CSS.success.icon }, h$s("calcite-icon", { icon: "check-circle-f", scale: "s" })), success === null || success === void 0 ? void 0 :
  ...
  renderOptions() {
    ...
    return (h$s("ul", { class: CSS.options, role: "menu" }, h$s("li", { id: "copyToClipboard", onClick: this.handleShareItem.bind(this, 'link'), role: "menuitem" }, h$s("span", { class: CSS.icon }, h$s("calcite-icon", { icon: "link", scale: "m" })), h$s("span", { class: CSS.optionText }, (_b = options === null || options === void 0 ? void 0 : options.link) === null || _b === void 0 ? void 0 : _b.label)), h$s("li", { onClick: this.handleShareItem.bind(this, 'facebook'), role: "menuitem" }, h$s("span", { class: CSS.icon }, this.renderFacebookIcon()), h$s("span", { class: CSS.optionText }, (_c = options === null || options === void 0 ? void 0 : options.facebook) === null || _c === void 0 ? void 0 : _c.label)), h$s("li", { onClick: this.handleShareItem.bind(this, 'twitter'), role: "menuitem" }, h$s("span", { class: CSS.icon }, this.renderTwitterIcon()), h$s("span", { class: CSS.optionText }, (_d = options === null || options === void 0 ? void 0 : options.twitter) === null || _d === void 0 ? void 0 : _d.label)), h$s("li", { onClick: this.handleShareItem.bind(this, 'linkedIn'), role: "menuitem" }, h$s("span", { class: CSS.icon }, this.renderLinkedInIcon()), h$s("span", { class: CSS.optionText }, (_e = options === null || options === void 0 ? void 0 : options.linkedIn) === null || _e === void 0 ? void 0 : _e.label))));
  }
  renderFacebookIcon() {
  ...
  renderTip() {
    ...
    return (h$s("div", { class: CSS.tipContainer }, h$s("span", { class: CSS.tipHeader }, h$s("calcite-icon", { icon: "lightbulb", scale: "s" }), h$s("span", null, info === null || info === void 0 ? void 0 : info.label)), h$s("p", { class: CSS.tipContent }, info === null || info === void 0 ? void 0 : info.tooltip)));
  }
  renderEmbed() {
    var _a, _b, _c;
    const embedMessages = (_a = this.messages) === null || _a === void 0 ? void 0 : _a.embed;
    return (h$s("div", { class: CSS.embed.container }, h$s("span", { class: CSS.embed.header }, h$s("calcite-icon", { icon: "code", scale: "m" }), h$s("span", null, (_c = (_b = this.messages) === null || _b === void 0 ? void 0 : _b.embed) === null || _c === void 0 ? void 0 : _c.label)), h$s("div", { class: CSS.embed.embedCode.container }, h$s("div", { class: CSS.embed.embedCode.textArea }, h$s("textarea", { ref: el => (this.embedCodeRef = el), cols: 30, rows: 4, readonly: true, value: this.getEmbedCode() }), h$s("button", { id: "copyEmbedToClipboard", onClick: this.copyEmbedCode.bind(this), class: CSS.embed.embedCode.copyButton }, h$s("calcite-icon", { icon: "copy", scale: "s" }), h$s("span", null, embedMessages === null || embedMessages === void 0 ? void 0 : embedMessages.copy))), h$s("span", { class: CSS.embed.textAreaText }, h$s("slot", { name: "text-area-text" })), h$s("div", { class: CSS.embed.dimensions.container }, h$s("label", { class: CSS.embed.dimensions.input }, h$s("span", null, embedMessages === null || embedMessages === void 0 ? void 0 : embedMessages.width), h$s("input", { ref: el => (this.embedWidthRef = el), type: "number", value: this.embedWidth })), h$s("label", { class: CSS.embed.dimensions.input }, h$s("span", null, embedMessages === null || embedMessages === void 0 ? void 0 : embedMessages.height), h$s("input", { ref: el => (this.embedHeightRef = el), type: "number", value: this.embedHeight }))))));
  }
  togglePopover(event) {
    event.stopPropagation();
